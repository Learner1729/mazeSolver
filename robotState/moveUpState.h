/**
 * @file moveUpState.h
 * @brief MoveUpState class header file
 * 
...
namespace stackfsm {
  namespace state {
    /**
     * @brief IdleState class, it handles the transition from Up state to
     *        other states.
     */
    class MoveUpState: public RobotState {
      public:
        /**
         * @brief MoveUpState class constructor
         */
        MoveUpState():RobotState("MoveUpState") {}
        
        /**
         * @brief MoveUpState class destructor
         */
        virtual ~MoveUpState() {}
