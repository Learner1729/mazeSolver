/**
 * @file moveDownState.h
 * @brief MoveDownState class header file
 * 
...
namespace stackfsm {
  namespace state {
    /**
     * @brief IdleState class, it handles the transition from Down state to
     *        other states.
     */
    class MoveDownState: public RobotState {
      public:
        /**
         * @brief MoveDownState class constructor
         */
        MoveDownState():RobotState("MoveDownState") {}
        
        /**
         * @brief MoveDownState class destructor
         */
